...
function Home() {
  ...
  return <div className="renew-home renew-home-v2">
    <section className="home-v2-hero" id="home"><div className="home-v2-shell home-v2-hero-grid"><div><p className="home-v2-kicker">{text.hero[0]}</p><h1>{text.hero[1]}</h1><p className="home-v2-lead">{text.hero[2]}</p><div className="home-v2-hero-price"><span>{language === "nl" ? "Bank reinigen" : "Sofa cleaning"}</span><strong>{priceById.banken.price[language]}</strong></div><p className="home-v2-price-note">{text.priceNote}</p><div className="home-v2-actions"><WhatsAppButton label={text.primaryCta} /><a className="btn btn-secondary" href="#prijzen">{text.pricesCta}</a></div></div><figure className="home-v2-hero-media"><ResponsiveCollage priority alt="Voor en na resultaat van bankreiniging met professionele apparatuur van RenewCleaning" /></figure></div></section>
