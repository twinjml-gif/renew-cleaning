export const siteContent = {
  nl: {
    common: {
      ...
      fromLeiden: "Gevestigd in Leiden",
      onLocation: "Aan huis en op locatie",
      menu: "Menu",
    ...
    footer: {
      tagline: "Luxe reiniging aan huis voor meubels, matrassen, kinderwagens en meer.",
      kvk: "KvK",
  ...
  en: {
    common: {
      ...
      fromLeiden: "Based in Leiden",
      onLocation: "At home and on location",
      menu: "Menu",
    ...
    footer: {
      tagline: "Luxury at-home cleaning for furniture, mattresses, strollers and more.",
